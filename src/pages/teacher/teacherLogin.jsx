                ...
                <Row>
                    <Col sm={"12"}>
                        <div className="myContainer" style={{paddingTop: "7em",minHeight: "calc(100vh - 336px)"}}>
                            ...
                            <div className="form">
                                <Form action="/teacher/code-verification" method='get'>
                                    <Form.Control type='text' placeholder='User Name' />
                                    <Form.Control className='my-3' type='password' placeholder='Password' />
                                    <Link className="d-block text-end text-muted mb-3" to="/teacher/forgot-password">Forgot Password?</Link>
                                    <Form.Control className='myBtn primary' type='submit' value={"Login"} />
                                    <div className="text-center text-muted pt-3">
                                        Don’t have an account? <Link to="#!" className="text-primary fw-bold text-uppercase">SignUp</Link>
                                    </div>
                                </Form>
                            </div>
                        </div>
