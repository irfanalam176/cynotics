...
export default function TeacherTermsOfUse() {
    return (
        <Page roundedLG={true} pageTitle={"terms of use"}>
            <div className="privacyPolicySection">
                ...
                <p className='policyText'>
                    For purposes of this Privacy Policy, "Your Information" or "Personal Data" means information about you, which may be of a confidential or sensitive nature and may include personally identifiable information ("PII") and/or financial information. PII means individually identifiable information that would allow us to determine the actual identity.
                </p>
            </div>
        </Page>
    )
